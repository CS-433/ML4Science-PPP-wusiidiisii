...
LastEditTime: 2022-12-20 22:13:26
LastEditors: YourName
Description: Integrate the label generated by the model
'''
import os
import json
import numpy as np

test_txt_path = './dataset_split/test_list.txt'

# Read the test dataset index file
test_file_list = []
...
true_file_path = './dataset'
model_output_path = './model_output'
pred_file_path = './prediction/matrix'
bg_index = 0
test_file_index = 0
for test_file_number in test_file_list:
    ...
    for test_file in test_files:
        ...
        # Add the output from the model into the json file
